  ...
  return (
    <div className="relative flex flex-col items-end px-3 gap-y-9 mt-28 lg:mt-10 md:px-0">
      ...
      <Image
        ...
        width={0}
        height={0}
        className="absolute -top-10 lg:top-1/2 left-2 lg:left-[10%] 2xl:left-0 w-14 h-auto lg:w-20"
      />
      <Image
        ...
        width={0}
        height={0}
        className="absolute hidden w-16 h-auto rotate-90 bottom-10 lg:-bottom-10 right-3/4 lg:-right-10 lg:block"
      />
    </div>
  );
};
