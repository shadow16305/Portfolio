  ...
  return (
    <div className="flex flex-col lg:flex-row justify-center lg:justify-between  mt-[187px] lg:mt-[211px] relative">
      <div className="flex flex-col gap-y-4 lg:gap-y-16 ps-3 lg:ps-0">
        ...
        <button className="relative w-[200px] h-[60px] lg:w-[257px] lg:h-[74px] rounded-[50px] bg-black text-white font-['NeueMontrealBold'] text-lg lg:text-2xl mt-12 lg:mt-16 transition-colors duration-300 overflow-hidden group">
      ...
      <div className="flex lg:flex-col items-center justify-center gap-9 mt-32 lg:mt-0">
        <SocialLinks
